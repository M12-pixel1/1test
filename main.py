...
symptoms_db = {
    ...
    "geltonavimas lapų": {"ligos": ["Trūksta azoto (augalams)", "Grybelis"], "tikimybes": [80, 60], "gydymas": ["Trąšos su azoto", "Fungicidai"]},
    # Pridėti daugiau iš šaltinių – tai placeholder'is, plėsime su realiais duomenimis
}
...
st.info("**Privatumas:** Jūsų duomenys saugūs, naudojami tik analizei ir nekaupiami (GDPR compliant).")
...
if not sutikimas:
    ...
    uploaded_video = st.file_uploader("Jei reikia detalesnės analizės (pvz., šlubavimas, garsai) – įkelk trumpą video", type=["mp4", "mov"])
